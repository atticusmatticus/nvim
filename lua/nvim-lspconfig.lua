...
local on_attach = function(client, bufnr)
  ...
  vim.api.nvim_set_keymap('i', '<c-s>', '<cmd>lua vim.lsp.buf.signature_help()<CR>', opts) -- apparently is needed to have persistent signajure_help
...
local servers = { "pyright", "bashls", "vimls", "clangd", "fortls", "texlab", "r_language_server", "rnix", "cssls"} --"sourcekit", 
